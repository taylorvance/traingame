...
export function getHexPoints(radius: number, centerX: number, centerY: number): string {
...
export function getHexVertices(radius: number, centerX: number, centerY: number): Point[] {
  const height = getHexHeight(radius)
...
export function getTrackPath(radius: number, centerX: number, centerY: number, entryEdge: Edge, exitEdge: Edge): string {
...
export function getEdgeSegment(radius: number, centerX: number, centerY: number, edge: Edge, inset = 0.2): { x1: number; y1: number; x2: number; y2: number } {
